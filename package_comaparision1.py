...
zone = sys.argv[3]
instance = sys.argv[4]
data_center = sys.argv[5]
system_working_directory = sys.argv[6]
...
def fetch_zone_and_instance_list(zone, instance, zone_and_instance_path): 
    server_alias_list = []
...
#checking for user inputon zone and instance
